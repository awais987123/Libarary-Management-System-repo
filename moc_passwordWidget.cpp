...
#include <memory>
#include "../../../Music/LibraryManagementSystem/GUI/passwordWidget.h"
...
QT_MOC_LITERAL(1, 15, 19), // "changeCurrentWidget"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 14) // "passBtnClicked"

    },
    "PasswordWidget\0changeCurrentWidget\0\0"
    "passBtnClicked"
};
...
void PasswordWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeCurrentWidget(); break;
        case 1: _t->passBtnClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PasswordWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PasswordWidget::changeCurrentWidget)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PasswordWidget::changeCurrentWidget()
{
